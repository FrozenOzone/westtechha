...
function customerTemplate(type,order,{approvalUrl='',siteUrl=''}){
  ...
  let subject='',headline='',intro='',action='',label='',url='',lines=[`Order: ${orderId}`,`Configuration: ${item}`];
