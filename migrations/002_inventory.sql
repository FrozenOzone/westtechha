...
INSERT OR IGNORE INTO component_inventory (component_sku, name, stock_qty, low_stock_threshold) VALUES
  ...
  ('command-30-enclosure', 'Command 30 enclosure with brass inserts', 0, 4),
  ('command-38-enclosure', 'Command 38 enclosure with brass inserts', 0, 4),
  ('command-30-gp-enclosure', 'Command 30 Garage Panel enclosure with brass inserts', 0, 4),
  ('command-38-gp-enclosure', 'Command 38 Garage Panel enclosure with brass inserts', 0, 4),
